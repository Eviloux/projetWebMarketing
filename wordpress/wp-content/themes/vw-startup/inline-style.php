<?php
	...
	if($vw_startup_first_color != false){
		$custom_css .='.search-box i, #header .main-navigation ul.sub-menu li a:hover, .req-button a, .more-btn a, .overlay-box:hover, input[type="submit"], .footer .tagcloud a:hover, .footer-2, .scrollup i, .sidebar input[type="submit"], .sidebar .tagcloud a:hover, nav.woocommerce-MyAccount-navigation ul li, .woocommerce #respond input#submit, .woocommerce a.button, .woocommerce button.button, .woocommerce input.button, .woocommerce #respond input#submit.alt, .woocommerce a.button.alt, .woocommerce button.button.alt, .woocommerce input.button.alt, .woocommerce span.onsale, .hvr-sweep-to-right:before, .pagination span, .pagination a{';
	...
	if($vw_startup_first_color != false){
		$custom_css .='a, .top-bar .custom-social-icons i:hover, .contact-info i, #header .main-navigation ul li a:hover, .footer h3, .sidebar th, .sidebar td, .sidebar td#prev a, .sidebar caption, .post-info i, .post-navigation a:hover .post-title, .post-navigation a:focus .post-title, .woocommerce-message::before, .main-navigation .current_page_item > a, .main-navigation .current-menu-item > a{';
